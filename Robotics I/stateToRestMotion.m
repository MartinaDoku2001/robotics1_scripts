function [time, position, velocity, acceleration] = stateToRestMotion(totalTime, accelerationValue, initialVelocity, initialPosition, constantVelocity, accelerationTime, coastingTime)
    % This function simulates the motion profile of a robot going from
    % a given state to rest
